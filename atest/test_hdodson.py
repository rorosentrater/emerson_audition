...
class TaskCreation(TestCase):
    ...
    def test_creation(self):
        ...
        # Create a new task
        create_default_task(self.driver)
...
def create_default_task(web_driver):
    web_driver.find_element_by_css_selector("#taskAssignee").send_keys("Lee")
    web_driver.find_element_by_css_selector("#taskTitle").send_keys("Nothing to do here")
    web_driver.find_element_by_css_selector("#taskContent").send_keys("Seriously")
